...
#nullable enable
    ...
    public sealed class CebTirage : INotifyPropertyChanged {
        ...
        /// </summary>
        /// <returns></returns>
        public async ValueTask<CebStatus> ClearAsync() {
        ...
        /// </summary>
        /// <returns></returns>
        public async ValueTask<CebStatus> RandomAsync() {
        ...
        /// </summary>
        /// <param name="pq"></param>
        public void SetPlaques(IList<int> pq) {
            SetPlaques(pq.ToArray());
        }
        ...
        public string? Solution(int no = 0) {
            return no >= 0 && no < Solutions.Count ? Solutions[no].ToString() : null;
        }
        ...
        /// <returns></returns>
        public async ValueTask<CebStatus> ResolveAsync(int search, params int[] plq) {
