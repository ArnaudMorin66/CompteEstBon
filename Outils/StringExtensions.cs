...
public static partial class StringExtensions {
    ...
    public static string Join(this IEnumerable<string> list, string separator) => string.Join(separator, list.ToArray());
    ...
    /// <returns>La chaine tronquée</returns>
    public static string Ellipsis(this string s, int maxLength, string ellipsisString) => s.Length <= maxLength ? s : s[..(maxLength - ellipsisString.Length)] + ellipsisString;
    ...
    public static bool EqualsWithNullAsEmpty(this string baseString, string comparedString) => string.IsNullOrEmpty(baseString) ? string.IsNullOrEmpty(comparedString) : baseString.Equals(comparedString);
    ...
    public static bool EqualsWithNullAsEmpty(this string baseString, string comparedString,
        ...
        string.IsNullOrEmpty(baseString) ? string.IsNullOrEmpty(comparedString) : baseString.Equals(comparedString, comparisonType);
    ...
    /// <returns>La portion de chaine demandée</returns>
    public static string To(this SubStringFrom subStringFrom, int end) => subStringFrom.String.Substring(subStringFrom.Start, end - subStringFrom.Start + 1);
    ...
    /// <returns>La portion de chaine demandée</returns>
    public static string Take(this SubStringFrom subStringFrom, int count) => subStringFrom.String.Substring(subStringFrom.Start, count);
