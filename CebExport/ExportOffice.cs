...
public static class ExportOffice {
    ...
    public static void SaveStreamExcel(this CebTirageBase tirage, Stream stream) {
        ...
        res += $": {tirage.Found}, Nombre de solutions: {tirage.Count}";
    ...
    public static void SaveStreamHtml(this CebTirageBase tirage, Stream stream) =>
        tirage.SaveStreamWordType(stream, FormatType.Html);

    public static void SaveStreamWord(this CebTirageBase tirage, Stream stream) => tirage.SaveStreamWordType(stream);

    public static void SaveStreamWordType(this CebTirageBase tirage, Stream stream, FormatType ftype = FormatType.Docx) {
